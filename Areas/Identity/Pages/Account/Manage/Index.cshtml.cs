...
namespace BlogProject.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        // InputModel Input is bound to the View and comes back from the user 
        [BindProperty]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // If user submits a new image, update user.Image using image service EncodeImageAsync
            // Then update user with userManager UpdateAsync
